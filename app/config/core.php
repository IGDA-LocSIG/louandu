...
define('APP_AUTH_PASSWORD_MODE', 1);
...
define('APP_WWW_URI', '/louandu/');

define('APP_WWW_DOMAIN', (isset($_SERVER['HTTPS'])?'https':'http').'://'.$_SERVER['SERVER_NAME']);
define('APP_WWW_URL', APP_WWW_DOMAIN.APP_WWW_URI);
...
define('APP_TOUCHY_AGENT', 'iPhone|iPod|iPad|Android'); // touch mobiles
define('APP_MOBILE_AGENT', APP_TOUCHY_AGENT.'|BlackBerry|Fennec|GoBrowser|IEMobile|Opera Mini|Opera Mobi');
