...
abstract class Helpable {
	...
	public function addHelper() {
		...
		// add helper with variable number of args (PHP 5.1.3 required)
		$reflectionClass = new ReflectionClass($class);
		array_unshift($args, $obj);
		$this->_helpers[$helper] = $reflectionClass->newInstanceArgs($args);
	}
	...
	protected function debugHelpers() {
		echo '<pre>';
		print_r($this->_helpers);
		echo '</pre>';
	}
}
