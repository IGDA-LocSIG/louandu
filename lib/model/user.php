...
abstract class UserModel extends Model {
	...
	public function __construct($table) {
    	...
    	$this->_properties = array(
    		...
    		'auto_login'			=> 'BOL',
    		'time_zone'				=> 'STR',
    		'language'				=> 'STR,'.json_encode($GLOBALS['config']['lang']),
    		'date_format_us'		=> 'BOL',
    		'creation_date'			=> 'DTM',
    		'expiration_date'		=> 'DTE',
    		'last_login_date'		=> 'DTM',
	...
	public function setLogin($login) 
	{
    	...
    	case 'email':
    		...
    		break;
    	default:
    		if (!$this->set('username',$login)) {
    			$this->_error['username'] = 'unable_to_set_user'; // TODO why ?
    			return false;
    		}
        }
		...
		if ($pass1 || $emptyIsOk) {
            ...
            if ($pass1) {
                ...
                if (VarPss::checkValid($pass1, $arr))
                {
                    ...
                    $this->_error['password'] = 'password_length';
                    return false;
                }
            } else {
                $this->data['password'] = '';
	...
	public function setupTimeZone() {
		if (!$this->isEmpty('time_zone') && $GLOBALS['config']['datetime']['timezone_model'] == 'user') {
			try {
